...
def build_headline(latest: WeeklyMetrics, deltas: dict[str, float], risks: list[dict], thresholds) -> str:
...
def build_risks(latest: WeeklyMetrics, previous: WeeklyMetrics, deltas: dict[str, float], thresholds) -> list[dict]:
